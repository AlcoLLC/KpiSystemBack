...
from .views import SubordinateListView, PerformanceSummaryView, KpiMonthlySummaryView, UserKpiScoreView
...
urlpatterns = [
    ...
    path('kpi-score/<slug:slug>/', UserKpiScoreView.as_view(), name='user-kpi-score'),
